...
namespace System.Memory.Tests
{
    public abstract class ReadOnlySequenceTestsCommon<T>
    {
        ...
        public void AsMultiSegment_CanGetFirst()
        {
            ...
            for (int s = 0; s < 3; s++)
            {
                for (int i = 100; i > 0; i--)
                {
                    ...
                    //Assert.Equal(i, buffer.FirstSpan.Length); // NetFx: This does not exist in System.Memory 4.5.5
        ...
        protected void VerifyCanGetFirst(ReadOnlySequence<T> buffer, int expectedSize)
        {
            ...
            //Assert.Equal(0, buffer.FirstSpan.Length); // NetFx: This does not exist in System.Memory 4.5.5
        }
